# Contributing to busser-minitest
...
```bash
git clone https://github.com/test-kitchen/busser-minitest.git
cd busser-minitest
bundle install
```
...
Maintainers do not bump `lib/busser/minitest/version.rb` or edit
